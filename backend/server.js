...
app.post("/check-registration", async (req, res) => {
    try {
        ...
        const [result] = await db.promise().query("SELECT * FROM student_registration_v2 WHERE tup_id = ?", [tup_id]);
...
app.post("/register", (req, res) => {
    ...
    const insertQuery = "INSERT INTO student_registration_v2 (tup_id, time) VALUES (?, ?)";
